...
"@
    ...
    Write-Host "Setting environment to Staging"
    [System.Environment]::SetEnvironmentVariable("DOTNET_ENVIRONMENT", "Staging", "Machine")

    # Download CAEVES software
    Write-Host "Downloading CAEVES software"
    $downloads = @(
        "https://caeveswebassets.blob.core.windows.net/caevesbuildimage/build/CAEVES.FCG.App_Release-staging-test.msi"
    )
...
"@ -Name "FCGLibV3" -Namespace "FCGNamespace"
	...
	$uri = "https://caeves-saashelper-stg.azurewebsites.net/api/UpsertCaevesCapacityMetrics?code=D_DZN0bKCy1Z0LtdbGoxBWW-2VfrhxQiZujJOXd3QW32AzFuiwv7zA=="
